...
# Copy the Pydantic models file if it doesn't exist
if [ ! -f "$PUBLIC_HTML/backend/models/pydantic_models.py" ]; then
    echo -e "${YELLOW}Pydantic models file not found. Creating it...${NC}"

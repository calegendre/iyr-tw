    ...
    <footer className="bg-gray-900 text-white py-8 border-t border-gray-800">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-lg font-bold mb-4">About ItsYourRadio</h3>
            <p className="text-gray-400 mb-4">
              Your Music, Your Way - connecting artists and listeners through the power of radio.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/artists" className="text-gray-400 hover:text-white transition">Artists</Link>
              </li>
              <li>
                <Link to="/podcasts" className="text-gray-400 hover:text-white transition">Podcasts</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start">
                ...
                <span>contact@itsyourradio.com</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <span>123 Broadcasting Street<br />Radio City, RC 10001</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-800 text-center text-gray-500">
          <p>&copy; {currentYear} ItsYourRadio. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );

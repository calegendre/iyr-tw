...
# itsyourradio Complete Deployment Script (Updated)
...
RADIO_STREAM_URL="https://stream.itsyourradio.com/radio/8000/radio.mp3"
...
# Create frontend files with enhanced media player
...
EOL
    ...
    # Create MediaPlayer component with enhanced functionality
...
EOL
    ...
    # Create App.js with live radio stream support
...
// Radio stream URL - update this to your actual stream URL
const RADIO_STREAM_URL = "$RADIO_STREAM_URL";
...
setup_python_environment() {
    ...
    # Set correct ownership for venv
...
# Create supervisor configuration with fixed permissions
setup_supervisor() {
    log_message "Step 9: Setting up supervisor..."
    
    # Create supervisor configuration (updated to use python -m uvicorn instead of direct uvicorn call)
...
main() {
    ...
    # Setup Python environment (with permission fixes)
    setup_python_environment
    ...
    # Setup supervisor (with fixed configuration)
    setup_supervisor
    ...
    log_message "Radio stream URL: $RADIO_STREAM_URL (Update this in the deployment script if needed)"
}
